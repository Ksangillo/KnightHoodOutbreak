...
public class FloatBehaviour : StateMachineBehaviour
{
    ...
    public bool stateEnter,stateExit, stateMachineEnter,stateMachineExit;
    ...
    override public void OnStateEnter(Animator anim, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (stateEnter)
        {
            anim.SetFloat(floatName, valueEnter);
        }
    }
    ...
    override public void OnStateExit(Animator anim, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (stateExit)
        {
            anim.SetFloat(floatName, valueExit);
        }
    }
